...
function faq_after_title_help_metabox_content() { 
	...
	<ol>
		<li><b>Via shortcode.</b> Just drop in the <code>[faq]</code> into any page or post, and it'll automatically show an accordion with all of your FAQs.</li>
		<li><b>Via Content Rows.</b> Add an <b>FAQ Accordion</b> row into any page with Content Rows enabled (most pages) and you'll get the same result.</li>
	</ol>";
 }